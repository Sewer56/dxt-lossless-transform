...
use crate::determine_optimal_transform::transform_bc1_auto;
use core::slice;
...
///
/// [`dltbc1_EstimateOptionsBuilder_BuildAndTransform`]: crate::c_api::determine_optimal_transform::dltbc1_EstimateOptionsBuilder_BuildAndTransform
#[unsafe(no_mangle)]
pub unsafe extern "C" fn dltbc1_unstable_transform_auto(
    ...
    match transform_bc1_auto(
        data_slice,
        output_slice,
        estimator_ref,
        settings.use_all_modes,
    ) {
