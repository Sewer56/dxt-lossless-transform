...
/// # Returns
///
/// The [`Bc1TransformDetails`] that produced the best (smallest) compressed size.
///
/// # Remarks
///
    ...
    T: SizeEstimationOperations,
{
    ...
    let mut last_tested = Bc1TransformDetails::default();
    ...
    if best_transform_details != last_tested {
        // Transform the data one final time with the best settings
        crate::transform_bc1(input_ptr, output_ptr, len, best_transform_details);
    }
