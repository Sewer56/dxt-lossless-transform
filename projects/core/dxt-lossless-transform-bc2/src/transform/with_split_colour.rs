...
pub(crate) unsafe fn transform_with_split_colour(
    ...
    // TODO: Implement BC2 color endpoint splitting while preserving alpha channel
    todo!("BC2 color splitting transform not yet implemented")
}
...
pub(crate) unsafe fn untransform_with_split_colour(
    ...
    // STUB: Implementation pending
    // TODO: Implement BC2 color endpoint recombination while preserving alpha channel
    todo!("BC2 color splitting untransform not yet implemented")
}
