/// Generic fallback implementation of split-colour transform for BC2.
...
pub(crate) unsafe fn transform_with_split_colour(
    ...
    while input_ptr < input_end {
        ...
        let color0 = (input_ptr.add(8) as *const u16).read_unaligned();
        let color1 = (input_ptr.add(10) as *const u16).read_unaligned();
