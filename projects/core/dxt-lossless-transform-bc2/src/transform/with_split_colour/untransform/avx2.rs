...
pub(crate) unsafe fn untransform_with_split_colour(
    ...
    while output_ptr < output_end {
        ...
        let colors_combined_laned_0 = _mm256_unpacklo_epi16(color0s, color1s);
        let colors_combined_laned_1 = _mm256_unpackhi_epi16(color0s, color1s);
...
mod tests {
    ...
    fn avx2_untransform_roundtrip() {
        ...
        // 256 bytes processed per main loop iteration (16 blocks * 16 bytes each)
        run_with_split_colour_untransform_unaligned_test(untransform_with_split_colour, 16, "AVX2");
    }
}
