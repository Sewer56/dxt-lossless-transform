...
unsafe fn transform_split_colour_and_decorr<const VARIANT: u8>(
    ...
    while input_ptr < input_end {
        ...
        let colors_only0 = match VARIANT {
            1 => decorrelate_ycocg_r_var1_avx2(colors_only0),
            2 => decorrelate_ycocg_r_var2_avx2(colors_only0),
            3 => decorrelate_ycocg_r_var3_avx2(colors_only0),
            _ => unreachable_unchecked(),
        };
        let colors_only1 = match VARIANT {
            1 => decorrelate_ycocg_r_var1_avx2(colors_only1),
            2 => decorrelate_ycocg_r_var2_avx2(colors_only1),
            3 => decorrelate_ycocg_r_var3_avx2(colors_only1),
            _ => unreachable_unchecked(),
        };
...
mod tests {
    ...
    fn avx2_transform_roundtrip(#[case] variant: YCoCgVariant) {
        ...
        // AVX2 processes 16 blocks at a time (256 bytes / 16 bytes per block = 16)
