...
/// Generic fallback implementation of split-alphas and decorrelate transform for BC3.
/// Splits standard interleaved BC3 blocks into separate arrays of alpha0, alpha1, alpha_indices,
/// decorrelated_colors and color_indices while applying YCoCg decorrelation to the color endpoints.
///
/// # Safety
///
...
pub(crate) unsafe fn transform_with_split_alphas_and_recorr(
    ...
    mut decorrelated_colors_out: *mut u32,
    ...
    while input_ptr < input_end {
        ...
        decorrelated_colors_out.write_u32_at(0, packed_colors);
...
mod tests {
    ...
    fn generic_transform_roundtrip() {
        ...
        run_split_alphas_and_recorr_transform_roundtrip_test(
