...
/// Generic fallback implementation of split-alphas, split-colour and recorrelate untransform for BC3.
/// Combines separate arrays of alpha0, alpha1, alpha_indices, decorrelated_color0,
/// decorrelated_color1 and color_indices back into standard interleaved BC3 blocks
/// while applying YCoCg recorrelation to the color endpoints. This reverses all optimizations.
///
/// # Safety
///
...
pub(crate) unsafe fn untransform_with_split_alphas_colour_and_recorr(
    ...
    mut decorrelated_color0_out: *const u16,
    mut decorrelated_color1_out: *const u16,
...
mod tests {
    ...
    fn can_untransform_unaligned() {
        ...
        run_with_split_alphas_colour_and_recorr_untransform_unaligned_test(
            untransform_with_split_alphas_colour_and_recorr,
            2,
            "untransform_with_split_alphas_colour_and_recorr (generic, unaligned)",
        );
    }
}
