...
#[inline]
pub unsafe fn transform_bc1(_input_ptr: *const u8, _output_ptr: *mut u8, _len: usize) {
    todo!()
}
...
/// - `input_ptr` and `output_ptr` must be 64-byte aligned (for performance and required by some platforms).
#[inline]
pub unsafe fn untransform_bc1(_input_ptr: *const u8, _output_ptr: *mut u8, _len: usize) {
    todo!()
}
...
pub unsafe fn transform_bc2(input_ptr: *const u8, output_ptr: *mut u8, len: usize) {
    dxt_lossless_transform_bc2::transforms::standard::split_blocks(input_ptr, output_ptr, len)
}
...
pub unsafe fn untransform_bc2(input_ptr: *const u8, output_ptr: *mut u8, len: usize) {
    dxt_lossless_transform_bc2::transforms::standard::unsplit_blocks(input_ptr, output_ptr, len)
}
