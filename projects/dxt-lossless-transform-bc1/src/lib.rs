    ...
    unsafe {
        ...
        match decorrelation_mode {
            ...
            YCoCgVariant::None => {
                ...
                unreachable!("None variant should not reach this function")
            }
        }
    }
}
...
unsafe fn untransform_split_and_decorrelate_variant1(
...
#[inline(never)] // improve register budget.
unsafe fn untransform_split_and_decorrelate_variant2(
    mut colors_ptr: *const u32,
    mut indices_ptr: *const u32,
    mut output_ptr: *mut u8,
    num_blocks: usize,
...
#[inline(never)] // improve register budget.
unsafe fn untransform_split_and_decorrelate_variant3(
    mut colors_ptr: *const u32,
    mut indices_ptr: *const u32,
    mut output_ptr: *mut u8,
    num_blocks: usize,
