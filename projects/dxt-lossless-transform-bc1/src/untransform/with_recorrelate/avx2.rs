...
use dxt_lossless_transform_common::intrinsics::color_565::recorrelate::avx2::{
    recorrelate_ycocg_r_var1_avx2, recorrelate_ycocg_r_var2_avx2,
    recorrelate_ycocg_r_var3_avx2,
};
...
unsafe fn untransform_recorr<const VARIANT: u8>(
    ...
    if vectorized_blocks > 0 {
        ...
        while block_index < vectorized_blocks {
            ...
            _mm256_storeu_si256(output_ptr.add(block_index * 8 + 32) as *mut __m256i, output_1);
            _mm256_storeu_si256(output_ptr.add(block_index * 8 + 64) as *mut __m256i, output_2);
            _mm256_storeu_si256(output_ptr.add(block_index * 8 + 96) as *mut __m256i, output_3);
...
mod tests {
    ...
    use crate::with_recorrelate::avx2::*;
    use crate::{
