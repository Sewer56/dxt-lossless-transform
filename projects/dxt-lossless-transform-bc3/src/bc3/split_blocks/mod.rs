...
#[cfg(any(target_arch = "x86_64", target_arch = "x86"))]
#[inline(always)]
unsafe fn split_blocks_bc3_x86(input_ptr: *const u8, output_ptr: *mut u8, len: usize) {
...
#[inline]
pub unsafe fn split_blocks_bc3(input_ptr: *const u8, output_ptr: *mut u8, len: usize) {
    debug_assert!(len % 16 == 0);

    #[cfg(any(target_arch = "x86_64", target_arch = "x86"))]
    {
        split_blocks_bc3_x86(input_ptr, output_ptr, len)
    }
...
#[cfg(test)]
pub mod tests {
    use crate::bc3::split_blocks::portable32::u32;
