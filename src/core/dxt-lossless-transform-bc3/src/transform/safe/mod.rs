//! Safe slice-based BC3 transform wrappers
//!
...
//! `dxt-lossless-transform-bc3-api` crate.

pub mod transform_auto;
pub mod transform_with_settings;

// Re-export the main functions with _safe suffix for discoverability
pub use transform_auto::{transform_bc3_auto as transform_bc3_auto_safe, Bc3AutoTransformError};
pub use transform_with_settings::{
    transform_bc3_with_settings as transform_bc3_with_settings_safe,
    untransform_bc3_with_settings as untransform_bc3_with_settings_safe, Bc3ValidationError,
};
