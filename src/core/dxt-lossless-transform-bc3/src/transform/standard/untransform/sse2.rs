...
mod tests {
    ...
    // u32 variant: used on x86, available for benchmarking on x86_64
    #[cfg(any(target_arch = "x86", feature = "bench"))]
    #[rstest]
    #[case(u32_untransform_sse2, "u32", 8)]
    fn test_u32_sse2_unaligned(
    ...
    // u64 variant: used on x86_64, available for benchmarking on x86
    #[cfg(any(target_arch = "x86_64", feature = "bench"))]
    #[rstest]
    #[case(u64_untransform_sse2, "u64", 8)]
    fn test_u64_sse2_unaligned(
        #[case] untransform_fn: StandardTransformFn,
        #[case] impl_name: &str,
        #[case] max_blocks: usize,
    ) {
