...
pub unsafe fn sse2_shuf_unroll2_impl_asm(
    ...
    super::sse2::sse2_shuf_unroll2_impl_asm(colors, colors_out, colors_len_bytes)
}
...
pub unsafe fn sse2_shuf_unroll2_impl(
    ...
    sse2::sse2_shuf_unroll2_impl(colors, colors_out, colors_len_bytes)
}
...
pub unsafe fn ssse3_pshufb_unroll2_impl(
    ...
    ssse3::ssse3_pshufb_unroll2_impl(colors, colors_out, colors_len_bytes)
}
...
pub unsafe fn ssse3_pshufb_unroll4_impl(
    ...
    ssse3::ssse3_pshufb_unroll4_impl(colors, colors_out, colors_len_bytes)
}

// AVX2 implementations
#[cfg(any(target_arch = "x86_64", target_arch = "x86"))]
pub unsafe fn avx2_shuf_impl_asm(colors: *const u8, colors_out: *mut u8, colors_len_bytes: usize) {
    super::avx2::avx2_shuf_impl_asm(colors, colors_out, colors_len_bytes)
}

#[cfg(any(target_arch = "x86_64", target_arch = "x86"))]
pub unsafe fn avx2_shuf_impl(colors: *const u8, colors_out: *mut u8, colors_len_bytes: usize) {
    avx2::avx2_shuf_impl(colors, colors_out, colors_len_bytes)
}
...
pub unsafe fn avx2_shuf_impl_unroll_2(
    ...
    avx2::avx2_shuf_impl_unroll_2(colors, colors_out, colors_len_bytes)
}
